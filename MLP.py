...
#Selecting Features based on heatmap analysis
...
name_Model="MLP Classifier"

# Creating and fitting the MLP model
model = MLPClassifier(solver='adam', learning_rate_init=0.001, learning_rate='constant', hidden_layer_sizes=(100, 100), alpha= 0.001, activation='tanh',max_iter=1000)
...
# Step 3: Calculate TruePositive, FalsePositive, TrueNegative, FalseNegatives for each class
...
# Step 4: Sum the TruePositive, FalsePositive, TrueNegative, FalseNegatives across all classes
